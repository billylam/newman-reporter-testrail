  ...
  handleTests(err, args) {
    ...
    for (let i = 0; i < strings.length; i++) {
      ...
      if (matches) {
        ...
        const matchingResultIndex = this.results.findIndex(prevResult =>
